<div class="container-fluid">
  <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-5 border-top">
    <div class="col mb-3">
      <a href="/" class="d-flex align-items-center mb-3 link-body-emphasis text-decoration-none gap-2">
        <img src="<?= IMG_PATH ?>0_home/zenoLogo.png" alt="zenoStock" width="32" height="32">
        <span class="fw-bold fs-5">zenoStock</span>
      </a>
